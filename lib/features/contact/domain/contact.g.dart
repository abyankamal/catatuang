...
extension ContactByIndex on IsarCollection<Contact> {
  Future<Contact?> getBySyncId(String syncId) {
    return getByIndex(r'syncId', [syncId]);
  }

  Contact? getBySyncIdSync(String syncId) {
  ...
  Future<List<Contact?>> getAllBySyncId(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'syncId', values);
  }

  List<Contact?> getAllBySyncIdSync(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putBySyncId(Contact object) {
    return putByIndex(r'syncId', object);
  }

  Id putBySyncIdSync(Contact object, {bool saveLinks = true}) {
    return putByIndexSync(r'syncId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllBySyncId(List<Contact> objects) {
    return putAllByIndex(r'syncId', objects);
  }

  List<Id> putAllBySyncIdSync(List<Contact> objects, {bool saveLinks = true}) {
...
extension ContactQueryWhereSort on QueryBuilder<Contact, Contact, QWhere> {
  ...
  QueryBuilder<Contact, Contact, QAfterWhere> anyIsActive() {
    return QueryBuilder.apply(this, (query) {
...
extension ContactQueryWhere on QueryBuilder<Contact, Contact, QWhereClause> {
  ...
  QueryBuilder<Contact, Contact, QAfterWhereClause> syncIdEqualTo(
      String syncId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterWhereClause> syncIdNotEqualTo(
      String syncId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Contact, Contact, QAfterWhereClause> isActiveEqualTo(
      bool isActive) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Contact, Contact, QAfterWhereClause> isActiveNotEqualTo(
      bool isActive) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ContactQueryFilter
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> isActiveEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isActive',
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'syncId',
        value: '',
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> syncIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'syncId',
        value: '',
...
extension ContactQuerySortBy on QueryBuilder<Contact, Contact, QSortBy> {
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> sortByIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByIsActiveDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> sortBySyncId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncId', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortBySyncIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ContactQuerySortThenBy
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> thenByIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByIsActiveDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.desc);
    });
  }
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> thenBySyncId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncId', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenBySyncIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncId', Sort.desc);
    });
  }
...
extension ContactQueryWhereDistinct
  ...
  QueryBuilder<Contact, Contact, QDistinct> distinctByIsActive() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QDistinct> distinctBySyncId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ContactQueryProperty
  ...
  QueryBuilder<Contact, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, String, QQueryOperations> syncIdProperty() {
    return QueryBuilder.apply(this, (query) {
